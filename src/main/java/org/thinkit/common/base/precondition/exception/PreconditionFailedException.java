...
/**
 * Thrown to indicate that a specified value or object does not meet the
 * preconditions as a result of the validation process.
 *
 * @author Kato Shinya
 * @since 1.0
 * @version 1.0
...
public final class PreconditionFailedException extends RuntimeException {
    ...
    /**
     * Constructs an <code>PreconditionFailedException</code> with no detail
     * message.
     */
    ...
    /**
     * Constructs an <code>PreconditionFailedException</code> with the specified
     * detail message.
     *
